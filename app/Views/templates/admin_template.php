    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url('dashboard') ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Level Immigration CMS</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block"><?= ucfirst(session()->get('user')['name']) ?></a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('properties') ?>" class="nav-link <?= uri_string() == 'properties' ? 'active' : '' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Properties</p>
                            </a>
                        </li>
